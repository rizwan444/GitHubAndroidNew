...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFragment.setVisibility(View.INVISIBLE);
        btnSFragment.setVisibility(View.INVISIBLE);
        btnRefresh.setVisibility(View.INVISIBLE);
        btnSharPrf.setVisibility(View.INVISIBLE);
        ...
        if(name1.equals("Got Nothing....")) {
            VMSG1.setVisibility(View.INVISIBLE);
        }
        else
        {
            VMSG1.setText(name1);
